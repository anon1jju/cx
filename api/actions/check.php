...
// --- KONEKSI DATABASE ---
$db_host = 'localhost';
$db_name = 'gandalfvalidasi'; // Ganti jika berbeda
$db_user = 'gandalfvalidasi'; // Ganti jika berbeda
$db_pass = 'gandalf123321'; // Ganti jika berbeda
$pdo = null;
...
try {
    ...
    error_log("DEBUG: Database connection successful."); // Log koneksi berhasil
} catch (PDOException $e) {
    error_log("FATAL: Database connection failed: " . $e->getMessage());
    $output['status'] = 'database_error';
    $output['message'] = "Database connection failed. Please check server logs."; // Pesan generik untuk klien
    // $output['message'] = "Database connection failed: " . $e->getMessage(); // Detail error (hati-hati di produksi)
